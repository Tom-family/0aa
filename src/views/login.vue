  ...
  <div class="login">
    <el-form ref="loginRef" :model="loginForm" :rules="loginRules" class="login-form">
      ...
      <el-form-item prop="phone">
        <el-input v-model="loginForm.phone" type="text" size="large" auto-complete="off" placeholder="账号">
      ...
      <el-form-item style="width: 100%">
        <el-button class="button-submit" :loading="loading" size="large" type="primary" style="width: 100%" @click.prevent="handleLogin">
...
.button-submit {
  background: linear-gradient(90deg, #7b61ff, #667eea);
...
:deep(.el-input__wrapper) {
  ...
  background: transparent;
  box-shadow: 0 0 0 1px rgba(123, 97, 255, 0.2) inset;
}
