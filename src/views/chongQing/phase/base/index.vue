<template>
  <div class="app-container">
    ...
    <el-table stripe v-loading="loading" :data="postList">
      ...
      <el-table-column label="关系标题" show-overflow-tooltip align="center" prop="srSort" />
      <el-table-column label="关系引导词" show-overflow-tooltip align="center" prop="createTime" min-width="100">
